...
def build_signal(cluster, top_entities, reasoning):
    return SignalDoc(
        ...
        india_relevance=scale10(reasoning.get("india_relevance", 5)),
        market_impact=reasoning.get("market_impact", ""),
        opportunity_score=scale10(reasoning.get("opportunity_score", 3)),
        risk_score=scale10(reasoning.get("risk_score", 3)),
